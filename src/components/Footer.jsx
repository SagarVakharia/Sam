...
const Footer = () => {
    return (
        <footer className="bg-black py-10 border-t border-white/10 text-center relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 relative z-10">
                <p className="text-gray-400 font-sans flex items-center justify-center gap-2 flex-wrap text-sm md:text-base">
